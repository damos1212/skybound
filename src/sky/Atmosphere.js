...
fn main() {
	...
	// sun transmittance at the viewer's altitude (the game's camera climbs through the atmosphere)
	let Ts = atmosphereSampleTransmittance( atmosphereParams.viewHeight, atmosphereParams.sunDir.y );
	irr[ 1 ] = vec4f( Ts, 1.0 );
